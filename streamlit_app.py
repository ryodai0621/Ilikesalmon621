...
time = st.slider("周期（秒）", min_value=0.1, step=0.01, value=1.0)
long = st.slider("単振り子の長さ（メートル）", min_value=0.1, step=0.01, value=4.9)

## 計算セクション
if st.button("計算"):
    try:
        gravity = (4*3.141592653589793238 * long) / (time ** 2)
